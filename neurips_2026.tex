...
\author{
  ...
  \texttt{smadariagar@ug.uchile.cl} \\
  \And
  Christ Devia \\
  Centro Nacional de Inteligencia Artificial (CENIA) \\
  Universidad de Chile, Santiago, Chile \\
  \texttt{cdevia@gmail.com} \\
  \AND
  Pedro Maldonado \\
  Centro Nacional de Inteligencia Artificial (CENIA) \\
  Biomedical Neuroscience Institute (BNI) \\
  Universidad de Chile, Santiago, Chile \\
  \texttt{pedro@uchile.cl} \\
}
\begin{document}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AQUÍ AÑADES TU TABLA DE CONECTIVIDAD
\subsection{Microcircuit Connectivity Matrix}
\label{tab:connectivity}
\begin{table}[h]
  \centering
  \caption{%
    \textbf{Connection probability matrix for the canonical microcircuit.}
    The table shows the probability of connection between any two neurons from a source population (columns) to a target population (rows). Values are derived from \citet{Potjans2014}. E: Excitatory neurons; I: Inhibitory neurons.
  }
  \label{tab:connectivity}
  \begin{tabular}{lcccccccc}
    \toprule
    \textbf{Target \textbackslash Source} & \textbf{L2/3e} & \textbf{L2/3i} & \textbf{L4e} & \textbf{L4i} & \textbf{L5e} & \textbf{L5i} & \textbf{L6e} & \textbf{L6i} \\
    \midrule
    L2/3e & 0.101 & 0.169 & 0.044 & 0.082 & 0.032 & 0.0 & 0.008 & 0.0 \\
    L2/3i & 0.135 & 0.137 & 0.032 & 0.052 & 0.076 & 0.0 & 0.004 & 0.0 \\
    L4e & 0.008 & 0.006 & 0.050 & 0.135 & 0.007 & 0.0 & 0.045 & 0.0 \\
    L4i & 0.069 & 0.003 & 0.079 & 0.160 & 0.003 & 0.0 & 0.106 & 0.0 \\
    L5e & 0.100 & 0.062 & 0.050 & 0.006 & 0.083 & 0.373 & 0.020 & 0.0 \\
